...
const HackerRoom = (props) => {
  ...
  return (
    <group {...props} dispose={null}>
      {nodes.computer_computer_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.server_server_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.vhs_vhsPlayer_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.shelf_stand_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.keyboard_mat_mat_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.arm_arm_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.Tv_tv_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.table_table_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.Cables_cables_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.props_props_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.screen_screens_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.screen_glass_glass_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.Ground_ground_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
      ...
      {nodes.peripherals_key_mat_0 && ( // Safe check if node exists
        <mesh
          castShadow
          receiveShadow
